...
exports.uploadWatchImages = upload.fields([
  {
    name: 'imageCover',
    maxCount: 1,
  },
...
exports.getAllWatches = catchAsync(async (req, res) => {
  const features = (
...
exports.getWatch = catchAsync(async (req, res) => {
...
exports.createWatch = catchAsync(async (req, res) => {
  try {
...
exports.updateWatch = catchAsync(async (req, res) => {
...
exports.deleteWatch = catchAsync(async (req, res) => {
